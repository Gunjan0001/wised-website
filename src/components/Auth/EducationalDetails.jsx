...
const EducationalDetails = ({ onClose }) => {
  ...
  const handleSemesterChange = (e) => {
    const { value } = e.target;
    setsemester(value);
    setYears(""); // Clear year when semester is selected
  };
  const totalSteps = 5;
      ...
      <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 xl:h-screen xl:py-8 px-3">
        <div className="w-full sm:w-[540px] bg-white shadow rounded-[40px] py-6 xl:py-11 px-5 md:px-10 mx-auto ">
          ...
          <form ref={formRef} onSubmit={handleSubmit}>
            ...
            {/* <div className="relative mt-6">
              ...
              <div className="relative w-full  py-[7px] px-[27px] pt-1.5 border overflow-hidden border-[#BEC1C3] rounded-[100px]">
                ...
                <span
                  onClick={() =>
                    setActiveDropdown(
                      activeDropdown === "company" ? "" : "company"
                    )
                  }
                  className="absolute top-1/2 right-4 transform -translate-y-1/2 cursor-pointer"
                >
            ...
            {/* <div className="relative mt-6">
              ...
              <div className="relative w-full py-[7px] pt-1.5 px-[27px] overflow-hidden border border-[#BEC1C3] rounded-[100px]">
                ...
                <span
                  onClick={() =>
                    setActiveDropdown(
                      activeDropdown === "workingHere" ? "" : "workingHere"
                    )
                  }
                  className="absolute top-1/2 right-4 transform -translate-y-1/2 cursor-pointer"
                >
                ...
                <div className="absolute left-0 w-full bg-white  border-[#BEC1C3] rounded-[10px] mt-1 shadow-lg z-10">
                  {workingHereOptions
                    .filter((option) =>
                      option
                        .toLowerCase()
                        .includes(workingHereTerm.toLowerCase())
                    )
                    .map((option, index) => (
                      <div
                        key={index}
            ...
            {/* <div className="relative mt-6">
              ...
              <div className="relative w-full py-[7px] pt-1.5 px-[27px] overflow-hidden border border-[#BEC1C3] rounded-[100px]">
                ...
                <span
                  onClick={() =>
                    setActiveDropdown(
                      activeDropdown === "designation" ? "" : "designation"
                    )
                  }
                  className="absolute top-1/2 right-4 transform -translate-y-1/2 cursor-pointer"
                >
                ...
                <div className="absolute left-0 w-full bg-white  border-[#BEC1C3] rounded-[10px] mt-1 shadow-lg z-10">
                  {industryOptions
                    .filter((option) =>
                      option
                        .toLowerCase()
                        .includes(designationTerm.toLowerCase())
                    )
                    .map((option, index) => (
                      <div
                        key={index}
            ...
            <div className="flex flex-wrap justify-between w-full mt-6">
              <div className="flex min-[400px]:w-1/2 flex-col gap-2">
                ...
                <div className="flex w-full gap-2">
                  <div className="flex w-1/2 flex-col gap-1 sm:px-2">
                    <div
              ...
              <div className="flex min-[400px]:w-1/2 flex-col gap-2">
                ...
                <div className="flex  w-full gap-2 ">
                  <div className="w-1/2 flex flex-col gap-1 ps-2">
                    <div
                      className={`flex justify-between border border-gray py-2 px-2 md:px-3 rounded-3xl ${getColorClass(
                        formData.month
                      )}`}
            ...
            {/* Location Input */}
            {/* <div className="relative mt-6">
              <label className="text-base font-medium" htmlFor="year">
              ...
              <div className="flex gap-3">
                <div className="relative w-full pt-1.5 py-[7px] px-[27px] border  border-[#BEC1C3] rounded-[100px]">
                  <input
                    ...
                    id="year"
                    value={years}
                    onChange={handleInputChange(setYears, "year")}
                    onClick={() => setActiveDropdown("year")}
                  />
                  <span
                    onClick={() =>
                      setActiveDropdown(activeDropdown === "year" ? "" : "year")
                    }
                    className="absolute top-1/2 right-4 transform -translate-y-1/2 cursor-pointer"
                  >
                    <DropDownIcon />
                  ...
                  {activeDropdown === "year" && (
                    <div className="absolute left-0 w-full bg-white  border-[#BEC1C3] rounded-[10px] mt-1 shadow-lg z-10">
                      {industryOptions
                        .filter((option) =>
                          option.toLowerCase().includes(years.toLowerCase())
                        )
                        .map((option, index) => (
                          <div
                            key={index}
                            className="px-4 py-2 border rounded-[10px] mt-1 p-1  hover:bg-blue-500 duration-300 hover:text-white cursor-pointer"
                            onClick={() =>
                              handleSelectOption(setYears, "year")(option)
                            }
                          >
                            {option}
                          </div>
                ...
                <div className="relative w-full pt-1.5 py-[7px] px-[27px] border  border-[#BEC1C3] rounded-[100px]">
                  <input
                    ...
                    value={semester}
                    onChange={handleInputChange(setsemester, "Semester")}
                    onClick={() => setActiveDropdown("Semester")}
                  />
                  <span
                    onClick={() =>
                      setActiveDropdown(
              ...
              {activeDropdown === "Semester" && (
                <div className="absolute left-0 w-full bg-white  border-[#BEC1C3] rounded-[10px] mt-1 shadow-lg z-10">
                  {industryOptions
                    .filter((option) =>
                      option.toLowerCase().includes(semester.toLowerCase())
                    )
                    .map((option, index) => (
                      <div
                        key={index}
                        className="px-4 py-2 border rounded-[10px] mt-1 p-1  hover:bg-blue-500 duration-300 hover:text-white cursor-pointer"
                        onClick={() =>
                          handleSelectOption(setsemester, "Semester")(option)
                        }
                      >
                        {option}
                      </div>
